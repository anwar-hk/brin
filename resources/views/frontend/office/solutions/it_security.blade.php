...
<section class="mbr-section article content12 cid-qvgUjfbLH0" id="content12-av" data-rv-view="1762">
    ...
    <div class="container">
        <div class="media-container-row">
            <div class="mbr-text counter-container col-12 col-md-8 mbr-fonts-style display-7 text-justify" uk-scrollspy="cls: uk-animation-slide-top; repeat: false; delay: 500;">
                <ul>
...
<section class="mbr-section article content12 cid-qvgUjfbLH0" id="content12-av" data-rv-view="1762">
    ...
    <div class="container">
        <div class="media-container-row">
            <div class="mbr-text counter-container col-12 col-md-8 mbr-fonts-style display-7 text-justify" uk-scrollspy="cls: uk-animation-slide-bottom; repeat: false; delay: 500;">
                <ul>
