...
<section class="about-section">
    ...
    <div class="background-layers">
        ...
        <div class="cws-image-bg" style="background-image: url(images/bgImages/bg-3.jpg)"></div>
    </div>
    ...
    <div class="auto-container">
        <div class="row">
            <div class="col-lg-6 col-md-12">
                <div class="sec-title">
                    <h2 uk-scrollspy="cls: uk-animation-slide-top; repeat: true; delay: 500;">SMART HOME</h2>
                    <div class="text" uk-scrollspy="cls: uk-animation-slide-left; repeat: true; delay:1000;">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer convallis accumsan mi nec elementum. Nulla ante metus, varius non condimentum id, molestie nec tellus.</div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="feature-block col-lg-4 col-md-4 col-sm-12">
                        <div class="inner-box">
                            <div class="icon-box" uk-scrollspy="cls: uk-animation-slide-left; repeat: true; delay: 500;">
                            ...
                            <h5 uk-scrollspy="cls: uk-animation-slide-top; repeat: true; delay: 500;">Managed <br>Centrally</h5>
                        </div>
                    </div>
                    ...
                    <div class="feature-block col-lg-4 col-md-4 col-sm-12">
                        <div class="inner-box">
                            <div class="icon-box" uk-scrollspy="cls: uk-animation-slide-left; repeat: true; delay: 800;">
                            ...
                            <h5 uk-scrollspy="cls: uk-animation-slide-top; repeat: true; delay: 800;" >Wirelessly <br>Connects</h5>
                        </div>
                    </div>
                    ...
                    <div class="feature-block col-lg-4 col-md-4 col-sm-12" >
                        <div class="inner-box">
                            <div class="icon-box" uk-scrollspy="cls: uk-animation-slide-left; repeat: true; delay: 1200;">
                                <svg class="icon 1.svg" viewBox="0 0 30 30">
                            ...
                            <h5 uk-scrollspy="cls: uk-animation-slide-top; repeat: true; delay: 1200;">Smart <br>Applications</h5>
                        </div>
                    </div>
                </div>  

                <!-- Btn Box -->
                <div class="btn-box" uk-scrollspy="cls: uk-animation-slide-right; repeat: true; delay: 800;">
